...
# For linux
GOOS=linux GOARCH=amd64 bash -c 'go build -o build/$GOOS/$GOARCH/terraform-provider-factorio'
```
...
```bash
mkdir -p $HOME/.terraform.d/plugins/registry.terraform.io/efokschaner/factorio/0.1/linux_amd64
cp build/linux/amd64/terraform-provider-factorio $HOME/.terraform.d/plugins/registry.terraform.io/efokschaner/factorio/0.1/linux_amd64
```
### tfplugindocs
